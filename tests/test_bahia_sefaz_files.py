...
def test_revenues_keep_budget_stages_separate(tmp_path: Path):
    ...
    file.write_text(
        "ANO EXERCICIO;ORGAO;NATUREZA RECEITA;VALOR PREVISTO;VALOR ATUALIZADO;VALOR ARRECADADO\n"
        "2025;SEC A;Impostos;100,00;120,00;90,00\n"
        "2026;SEC A;Impostos;200,00;220,00;180,00\n"
        "2026;SEC B;Taxas;50,00;60,00;55,00\n",
        encoding="utf-8",
    )
...
def test_licitacoes_zip_summarizes_related_tables_without_republishing_people(tmp_path: Path):
    ...
    assert result["archive"]["tabular_members"] == 2
    assert result["total_rows_across_related_tables"] == 5
    assert result["selected_rows_across_related_tables"] == 4
