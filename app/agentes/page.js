    ...
    <>
      <section className="page-hero">
        <div className="shell">
          ...
          <p>
            Prefeito, vice-prefeita, secretários verificados e vereadores reunidos em uma única consulta. Contatos e funções adicionais só aparecem quando a própria fonte oficial os publica.
          </p>
        ...
        <div className="shell">
          <div className="grid grid-3">
            <div className="card stat accent">
              ...
              <div><span className="stat-value">{integer(data.summary.executive)}</span><div className="stat-meta">prefeito, vice e secretários com fonte oficial</div></div>
            </div>
            ...
            <div className="card stat blue">
              ...
              <div><span className="stat-value">{integer(data.summary.leadershipContacts)}</span><div className="stat-meta">Mesa Diretora e funções correlatas publicadas pela CMS</div></div>
            </div>
          </div>
        </div>
      </section>
